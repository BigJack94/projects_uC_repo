...
float Adafruit_bme280_readPressure(uint8_t sensor) { 
    if ((sensor > SENSORS-1) && (sensor < 0)) { // argue sensor out of range
        return NAN;                                                                        
    }     
  ...
  var1 = ((int64_t)t_fine[sensor]) - 128000;                                                                
  var2 = var1 * var1 * (int64_t)_bme280_calib[sensor].dig_P6;                   
  var2 = var2 + ((var1 * (int64_t)_bme280_calib[sensor].dig_P5) * 131072);
  var2 = var2 + (((int64_t)_bme280_calib[sensor].dig_P4) * 34359738368);
  var1 = ((var1 * var1 * (int64_t)_bme280_calib[sensor].dig_P3) / 256) +
         ((var1 * ((int64_t)_bme280_calib[sensor].dig_P2) * 4096));
  var3 = ((int64_t)1) * 140737488355328;
  var1 = (var3 + var1) * ((int64_t)_bme280_calib[sensor].dig_P1) / 8589934592;
  ...
  var1 = (((int64_t)_bme280_calib[sensor].dig_P9) * (var4 / 8192) * (var4 / 8192)) /
         33554432;
  var2 = (((int64_t)_bme280_calib[sensor].dig_P8) * var4) / 524288;
  var4 = ((var4 + var1 + var2) / 256) + (((int64_t)_bme280_calib[sensor].dig_P7) * 16);
